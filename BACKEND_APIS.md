...
### Note Sync Fields (Important)
- `parent_note_id` (optional UUID string): links a voice follow-up note to its source voice note.
- Example in `changes.notes.updated[]`: `{ "id": "...", "title": "...", "parent_note_id": "parent-note-uuid" }`
